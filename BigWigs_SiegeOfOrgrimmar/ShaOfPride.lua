...
function mod:GetOptions()
	return {
		...
		{146595, "PROXIMITY"}, 144400, -8257, {-8258, "FLASH"}, {146817, "FLASH", "PROXIMITY"}, -8270, {144351, "DISPEL"}, {144358, "TANK", "FLASH", "EMPHASIZE"}, -8262, 144800, 144563, -8349, 144836,
...
function mod:OnBossEnable()
	...
	self:Log("SPELL_DAMAGE", "UnleashedBolt", 144836)
end
...
do
	local prev = 0
	function mod:UnleashedBolt(args)
		local t = GetTime()
		if t-prev > 5 then
			prev = t
...
function mod:Unleashed() -- Final Gift
	...
	self:Bar(144836, 10.6) -- Unleashed Bolts
	if self:Heroic() then
