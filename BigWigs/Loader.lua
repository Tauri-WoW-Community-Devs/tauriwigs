...
do
	...
	public.zoneTbl = {
		...
		[875]=lw, [885]=lw, [871]=lw, [874]=lw, [898]=lw, [877]=lw, [887]=lw, [876]=lw, [867]=lw, -- MoP
	}
end
...
do
	...
	function mod:VersionCheck(prefix, message, sender)
		if prefix == "VR" or prefix == "VQ" then
			...
			--SendChatMessage(message.."-"..sender, "RAID")
			...
			--if not message or message == 0 or message > 13000 then SendChatMessage("KILL", "RAID") return end -- Allow addons to query Big Wigs versions by using a version of 0, but don't add them to the user list.
