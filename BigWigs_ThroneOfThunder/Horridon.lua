...
function mod:OnEngage()
	...
	self:CDBar(136741, 15.5) -- Double Swipe
	self:CDBar(-7080, 31) -- Charge
	if self:Heroic() then
...
function mod:Swipe(args)
	...
	local timer = (args.spellID == 136770) and 11 or 17 -- after charge swipe is ~10 sec, then ~19 till next charge ( 10 H ptr )
