...
function mod:GetOptions()
	return {
		{-6969, "TANK"},
		136037, {136050, "TANK"}, 136216, 142028, {136218, "PROXIMITY"}, {136228, "ICON"}, 136245, {136246, "PROXIMITY"}, -7830, {-6960, "FLASH"},
		"berserk", "bosskill",
	}, {
		[-6969] = "heroic",
		[136037] = "general",
...
function mod:OnBossEnable()
	...
	self:Log("SPELL_CAST_SUCCESS", "LivingFluid", 142028)
...
function mod:OnEngage()
	...
	self:Bar(136037, 3) -- Primordial Strike
	self:Bar(142028, 15) -- living fluid spawns
	self:DelayedMessage(142028, 15, "Important", "Living Fluids")

	if self:Heroic() then
		horrorcounter = horrorcounter + 1
		self:Bar(-6969, 12, ("[%d] %s"):format(horrorcounter, self:SpellName(137000)), "spell_yorsahj_bloodboil_black") -- Viscous Horror
...
function mod:LivingFluid()
end

function mod:ViscousHorror()
	horrorcounter = horrorcounter + 1
	self:Message(-6969, "Attention", nil, nil, 137000)
	self:Bar(-6969, 30, ("[%d] %s"):format(horrorcounter, self:SpellName(137000)), "spell_yorsahj_bloodboil_black")
